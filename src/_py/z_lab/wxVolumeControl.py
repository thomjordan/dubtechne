...
# from: https://github.com/kdschlosser/wxVolumeKnob/blob/master/wxVolumeCtrl.py
...
class Handler(object):
    ...
    def __init__(self):
        ...
        self._neon_radius = 22
        self._neon_colour = wx.Colour(75, 0, 130)
...
'''
    class Frame(wx.Frame):
        ...
        def __init__(self):
            ...
            ctrl = KnobCtrl(self, value=0.0, minValue=0.0, maxValue=127.0, increment=1.0, knobStyle=KNOB_DEPRESSION | KNOB_SHADOW)
            ctrl.SetThumbSize(11)
            ...
            ctrl.SetPrimaryColour((33, 36, 60, 255))
